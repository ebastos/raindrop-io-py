...
# Order: the first 4 are READ-ONLY, followed by Collection examples and then Raindrop ones.
...
run("examples/highlights_and_bulk_demo.py")
run("examples/raindrop_note_demo.py")
